...
[TwitterTweetEmbed](https://github.com/saurabhnemade/react-twitter-embed) のような気の利いたコンポーネントを埋め込めるのは、個人で使う分には便利ですね。

<TwitterTweetEmbed tweetId={'1294846997313200128'} />

### Typescript

型システムとよくできた型、よくできたLanguage Serverがあると、型自身がある程度ドキュメントとなるので、コードジャンプするだけでドキュメントにアクセスできるようになり、開発中に仕様にアクセスするコストをだいぶ減らすことができる。補完が効くのでついでにタイピングの量とタイポなどのポカミスも減らせる。たんに型システムが好きというのもある。
